...
class MafiaStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ChangeOverallTime = channel.unary_unary(
                '/mafia.Mafia/ChangeOverallTime',
                request_serializer=mafia__pb2.ChangeOverallTimeRequest.SerializeToString,
                response_deserializer=mafia__pb2.ChangeOverallTimeResponse.FromString,
                )
...
class MafiaServicer(object):
    ...
    def ChangeOverallTime(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_MafiaServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ChangeOverallTime': grpc.unary_unary_rpc_method_handler(
                    servicer.ChangeOverallTime,
                    request_deserializer=mafia__pb2.ChangeOverallTimeRequest.FromString,
                    response_serializer=mafia__pb2.ChangeOverallTimeResponse.SerializeToString,
            ),
...
class Mafia(object):
    ...
    def ChangeOverallTime(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/mafia.Mafia/ChangeOverallTime',
            mafia__pb2.ChangeOverallTimeRequest.SerializeToString,
            mafia__pb2.ChangeOverallTimeResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
